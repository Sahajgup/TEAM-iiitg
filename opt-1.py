# Need to check if preprocess3 is working correctly for edge components
# Need to update : proceed with ILP Phase II if only needed
...
def preprocess3(graph, deg, n0, n1, final_to_original):
    ...
    return fil_graph, updated_n0, updated_n1, new_final_to_original, new_original_to_final

def preprocess2(graph, deg, n0, n1, final_to_original, original_to_final):
...
def preprocess1(graph, deg, n0, n1):
    ...
    return fil_graph, updated_n0, updated_n1, new_final_to_original, new_original_to_final, new_deg, zero_deg_node_b
    ...
    for line in sys.stdin:
        ...
        if p_line is None and line.startswith('p'):
            ...
            if n0 * n1 == m:
                complete = True
                del p_line, ocr
                return adjacency_list, n0, n1, m, complete, max_degree, edges, deg
...
def main():
    graph, n0, n1, m, complete, max_degree, edges, deg = read_graph()
    ...
    # new_final_to_original = map <int, int>
    fil_graph, updated_n0, updated_n1, new_final_to_original, new_original_to_final, new_deg, zero_deg_node_b = preprocess1(graph, deg, n0, n1)

    del graph  # Graph is no longer needed after this point

    # p2_final_to_original = map <int, vector <int>>
    p2_fil_graph, p2_n0, p2_n1, p2_final_to_original, p2_deg = preprocess2(fil_graph, new_deg, updated_n0, updated_n1, new_final_to_original, new_original_to_final)

    # p1_final_to_original = map <int, int>
    p1_fil_graph, p1_n0, p1_n1, p1_final_to_original, p1_original_to_final = preprocess3(p2_fil_graph, p2_deg, p2_n0, p2_n1, p2_final_to_original)
